...
function crossStart() {
    ...
    hoverResetX();
    enabledBtns();
    textStyle.innerHTML = "Kryss börjar";
...
function circleStart() {
    ...
    hoverResetO();
    enabledBtns();
    textStyle.innerHTML = "Cirkel börjar";
...
function switchTurn() {
    if (!circleTurn) {
        textStyle.innerHTML = "Cirkels tur";
    }
    if (circleTurn) {
        textStyle.innerHTML = "Kryss tur";
    }
}

function turnDecide() {
    if (!circleTurn + (f.f1 + f.f2 + f.f3 + f.f4 + f.f5 + f.f6 + f.f7 + f.f8 + f.f9 !== 0)) {
        return textStyle.innerHTML = "Kryss börjar";
    }
    if (circleTurn + (f.f1 + f.f2 + f.f3 + f.f4 + f.f5 + f.f6 + f.f7 + f.f8 + f.f9 !== 0)) {
        return textStyle.innerHTML = "Cirkel börjar";
    }
}
...
function checkGameover() {
    if (f.f1 + f.f2 + f.f3 + f.f4 + f.f5 + f.f6 + f.f7 + f.f8 + f.f9 === 9) {
        textStyle.innerHTML = "Oavgjort";
        restart.innerHTML = "Returmatch";
    }
}
...
function crossWin() {
    ...
    textStyle.innerHTML = "Kryss vann!";
...
function circleWin() {
    ...
    textStyle.innerHTML = "Cirkel vann!";
